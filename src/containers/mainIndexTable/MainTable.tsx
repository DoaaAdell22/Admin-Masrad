...
function MainTable({
  ...
  const { isPending, isError, data, error, refetch, isRefetching, isFetching } =
    useQuery({
      queryKey: [url, queryParams, defaultParams],
  ...
  const SHOW_IMPORT = importFile && getPermissions("files", "import", profile);
  return (
